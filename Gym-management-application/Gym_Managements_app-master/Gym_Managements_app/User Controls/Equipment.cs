        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Name != "" && textBox1.Text != "" && Type != "" && Manufacturer != "" && textBox5.Text != "" && Pdate != ""
                    && Edate != "" && Description != "")
                {
                    SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""E:\SWE\practice\projects\Gym_management_1_1 (1).mdf"";Integrated Security=True;Connect Timeout=30");
