...
namespace Gym_Managements_app.User_Controls
{
    public partial class PersonalTraining : UserControl
    {
        ...
        private void LoadPersonalTrainingGrid()
        {
            ...
            string con = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""E:\SWE\practice\projects\Gym_management_1_1 (1).mdf"";Integrated Security=True;Connect Timeout=30";
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            if (textSearch.Text != "")
            {
                ...
                string constring = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""E:\SWE\practice\projects\Gym_management_1_1 (1).mdf"";Integrated Security=True;Connect Timeout=30";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""E:\SWE\practice\projects\Gym_management_1_1 (1).mdf"";Integrated Security=True;Connect Timeout=30");
