...
namespace Gym_Managements_app.User_Controls
{
    public partial class NewMember : UserControl
    {
        ...
        public string conString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""E:\SWE\practice\projects\Gym_management_1_1 (1).mdf"";Integrated Security=True;Connect Timeout=30";
        //public int ID;
